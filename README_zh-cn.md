...
| --- | --- | --- | --- | --- | --- |
| 1 | 236.627ms | 845.565ms | 1.323s | 922.900ms | 30.700ms |
| 2 | 230.662ms | 942.218ms | 1.336s | 659.968ms | 23.244ms |
| 3 | 216.362ms | 836.226ms | 1.476s | 680.129ms | 23.198ms |
| 4 | 214.827ms | 828.115ms | 1.173s | 651.618ms | 23.511ms |
| 5 | 220.415ms | 830.026ms | 1.170s | 654.922ms | 23.196ms |
| Average | 223.779ms | 856.430ms | 1.296s | 713.908ms | **24.770ms** |
| Total | 1.119s | 4.282s | 6.478s | 3.570s | **123.849ms** |
| Speed vs quickjs-go（cgo / QuickJS-ng） | **1.00x** | 0.26x | 0.17x | 0.31x | 9.03x |

## AreWeFastYet V8-V7

| Metric | quickjs-go（cgo / QuickJS-ng） | GOJA（pure Go） | ModerncQuickJS（ccgo / QuickJS） | QJS（Wasm / wazero） | V8go（cgo / V8 JIT） |
| --- | --- | --- | --- | --- | --- |
| Richards | 1349 | 422 | 261 | 235 | **22883** |
| DeltaBlue | 1444 | 311 | 285 | 216 | **68022** |
| Crypto | 1139 | 228 | 314 | 363 | **54728** |
| RayTrace | 1928 | 462 | 512 | 755 | **166720** |
| EarleyBoyer | 3405 | 1105 | 765 | 1249 | **159087** |
| RegExp | 457 | 425 | 192 | 153 | **22046** |
| Splay | 3577 | 2041 | 1214 | 2023 | **57932** |
| NavierStokes | 1767 | 477 | 437 | 497 | **67683** |
| Score (version 7) | 1596 | 531 | 418 | 477 | **61142** |
| Duration (seconds) | 34.817s | 64.291s | 73.205s | 66.383s | **20.049s** |
| Score vs quickjs-go（cgo / QuickJS-ng） | **1.00x** | 0.33x | 0.26x | 0.30x | 38.31x |
| Speed vs quickjs-go（cgo / QuickJS-ng） | **1.00x** | 0.54x | 0.48x | 0.52x | 1.74x |
